        ...
        <div className='sm:px-[32px] sm:py-0 max-w-[1300px] m-auto'>
            <div className='flex gap-32'>
                <div className='flex-1'>
                      <h3 className='sm:text-[4rem] max-w-[500px] font-[Heading] uppercase leading-[77px]'>Redefining Web Development at
                ...
                <div className='flex-1'>
                    ...
                    <div>
                      <span className="uppercase text-[13px] font-light text-[#fefce899]">Companies i've worked with</span>
                      <div className="mt-2">
