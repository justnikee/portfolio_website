      ...
      <div className="px-5 sm:px-[32px] sm:py-0 max-w-[1300px] m-auto">
        <div className="flex flex-col gap-8 md:flex-row lg:gap-32">
          <div ref={leftContainer} className="flex-1 opacity-0">
            <h3 className="sm:text-[4rem] text-[2.5rem] leading-[3rem] max-w-[500px] font-[Heading] uppercase lg:leading-[5rem]">
              Hi, I&apos;m
              <span
            ...
            <div>
              ...
              >
                ...
                >
                  <path
                    fill="currentColor"
                    d="M0 0h29.998L30 7.058 0 7.06V.001Z"
                  ></path>
                  <path
                    fill="currentColor"
                    d="M29.998 0 30 30h-7.06V0h7.058Z"
                  ></path>
                  <path
                    fill="currentColor"
