  ...
  return (
    <>
      ...
      <div className="h-[70px] w-full">
        <Image
          src={"/main_images/shopify_logo_white.png"}
          width={200}
          height={70}
          alt="shopify icon"
          className="shopify-icon object-contain w-[200px] max-w-[200px]"
        />
      </div>
      <div className="h-[70px] w-full">
        <Image
          src={"/main_images/wordpress.png"}
          width={70}
          height={70}
          alt="wordpress icon"
          className="object-contain max-w-[70px] bg-white rounded-full"
        />
      </div>
    </>
  );
