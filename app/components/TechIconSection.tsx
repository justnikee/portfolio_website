...
const TechIconSection = () => {
  ...
  useGSAP(() => {
        gsap.fromTo(iconsectionref.current, {
          opacity: 0,
          y: 150
        }, {
            opacity: 1,
  ...
  return (
        <div ref={iconsectionref}>
            <div className='flex justify-center mt-7'>
               <Image className='absolute' src="/main_images/tech-bg.svg" width={600} height={100} alt="dots" />
                <div>
